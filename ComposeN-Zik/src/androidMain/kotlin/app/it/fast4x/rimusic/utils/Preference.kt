...
object Preference {
    ...
    val HOME_SONGS_DISLIKED_SORT_BY = Key( "HomeSongsDislikedSortBy", SongSortBy.DateLiked )
    ...
    val HOME_ARTISTS_DISLIKED_SORT_BY = Key( "HomeArtistsDislikedSortBy", ArtistSortBy.Name )
    ...
    val HOME_ALBUMS_DISLIKED_SORT_BY = Key( "HomeAlbumsDislikedSortBy", AlbumSortBy.Title )
    ...
    val HOME_SONGS_DISLIKED_SORT_ORDER = Key( "HomeSongsDislikedSortOrder", SortOrder.Ascending )
    ...
    val HOME_ARTISTS_DISLIKED_SORT_ORDER = Key( "HomeArtistsDislikedSortOrder", SortOrder.Ascending )
    ...
    val HOME_ALBUMS_DISLIKED_SORT_ORDER = Key( "HomeAlbumsDislikedSortOrder", SortOrder.Ascending )
